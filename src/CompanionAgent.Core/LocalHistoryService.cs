...
// Internal helper record used only within LocalHistoryService
file sealed record HistoryImportResult(List<ImportedSession> Sessions, List<PersonalBestRecord> PersonalBests);
